...
fn find_collatz_sequence_dynamically_smarter(x: i32) -> Vec<i32> {
    let mut collatz_sequence = Vec::new();
    let mut p = x;
...
pub fn run_collatz() {
    // let mut collatz_sequences: Vec<Vec<i32>> = Vec::new();
    for x in 1..100 {
        // let collatz_sequence = 
        // find_collatz_sequence(x);
        // let collatz_sequence = 
        // find_collatz_sequence_dynamically(x, collatz_sequences.clone());
        // let collatz_sequence = 
        find_collatz_sequence_dynamically_smarter(x);
